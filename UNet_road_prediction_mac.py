...
input_dir = '/Volumes/PortableSSD/Malaysia/01_Blueprint/04_UNet_road/03_prediction/Slope_Homo/tiles/images'
output_dir = '/Volumes/PortableSSD/Malaysia/01_Blueprint/04_UNet_road/03_prediction/Slope_Homo/OUT'

file_list = glob.glob(input_dir+ "/*.tif")

#作成したモデルを読み込みます(上のdefとmodel = UNet(3,1).cuda()のところを回す)
model_dir = '/Volumes/PortableSSD/Malaysia/01_Blueprint/04_UNet_road/02_training/SLOPE05m_Homo/model'
