...
# try using grayscale image as medium
"""
...
# train_dataset = LoadDataSet(dataset_path, transform=get_train_transform(size))
...
## This is data augumentation section
## maybe came from: https://www.kaggle.com/code/bguberfain/elastic-transform-for-data-augmentation
## random affine seems liner transformation
...
DEVICE = device
model = SwinUNet(size,size,1,BATCH_SIZE,1,3,4).to(DEVICE) #(H, W, ch, C, num_class?, num_blocks=3, patch_size = 4) #ori: 224,224,1,32,1,3,4
