...
#check
gpd_polygonized_raster.to_file(os.path.join(out_dir,"grid_01degree.shp"), crs="epsg:4326")
...
#いっかい出さないとだめぽい
stat_dic = zonal_stats(os.path.join(out_dir,"grid_01degree.shp"), palmras_nan_name, 
