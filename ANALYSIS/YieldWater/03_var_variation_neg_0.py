...
pearson_dir = f"/Volumes/SSD_2/Malaysia/02_Timeseries/YieldWater/01_correlation_timelag/{pp}"
...
out_dir = f'/Volumes/SSD_2/Malaysia/02_Timeseries/YieldWater/03_var_variation/{pp2}'
