...
for i, row in tqdm(gdf_region.iterrows()):
    ...
    if reginame in nondata_region:
        ...
        if len(df_peason_abs.dropna(how='all')) == 0:
            ...
            df_criti_ave_s = df_criti_s.mean(axis=1)
            ...
            criti_result[reginame] = [criti_var, criti_month, criti_sd, criti_slp]
...
df_result= df_result.rename(columns={0:"var",1:"month",2:"std",3:"MKslope"})
...
def collect_ano(tarvar):
    ...
    both_ano[tarvar] = [cv_var_sorted, slope_var_sorted]
